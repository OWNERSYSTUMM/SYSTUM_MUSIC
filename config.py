...
# --------------------------------------------------------
BOT_USERNAME = getenv("BOT_USERNAME","VIKKY_MUSICBOT")
# --------------------------------------------------------
...
OWNER_ID = int(getenv("OWNER_ID", 7299227823))
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/OWNERSYSTUMM/SYSTUM_MUSIC",
)
...
START_IMG_URL = getenv(
    "START_IMG_URL", "https://telegra.ph/file/451a8e1a363dc17c89556.jpg"
)
PING_IMG_URL = getenv(
    "PING_IMG_URL", "https://telegra.ph/file/bbda2b81f3a6786e22d2f.jpg"
)
